 ...
 *
 * Usage:
 *   node scripts/extract-images.cjs [options]
 */
...
Usage:
  node scripts/extract-images.cjs <url1> [url2] [url3] ...

Examples:
  node scripts/extract-images.cjs https://rbelaw.com/ https://rbelaw.com/our-team/
  node scripts/extract-images.cjs https://rbelaw.com/our-team/legal-assistants/
    `)
  process.exit(1)
}
...
extractFromPages(pages)
  .then(results => {
    ...
    console.log(`   node scripts/download-images.cjs --list ${outputFile}`)
  })
  .catch(console.error)
