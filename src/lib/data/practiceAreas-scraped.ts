...
// Last updated: 2026-01-08T06:51:36.070Z
...
export const practiceAreas: PracticeArea[] = [
  {
    ...
    "name": "Bankruptcy & Reorganization - Riley Bennett Egloff LLP",
  ...
  },
  {
    ...
    "sections": [
      {
        "title": "Business Entity Selection & Formation",
        "content": "There are many important decisions to be made by an emerging business, each of which comes with potential pitfalls that can be damaging to the business and its owners in the absence of proper legal guidance. Our business law attorneys can help you with these issues, steering you clear of the problems while helping you select the type of entity which best serves your business interests and goals. From drafting the formation documents to stock issuance to agreements between co-owners, our Firm’s business attorneys can help you establish a solid legal foundation for your business future."
      },
      {
        "title": "Business Contract Review, Drafting & Negotiation",
        "content": "Beyond the formation of business entities, Riley Bennett Egloff acts as corporate counsel for many of its business clients, including the negotiation, drafting and review of our clients’ contracts, ranging in size from a few thousand dollars to millions of dollars. With just a few hours’ time, our review of contracts before they are signed can help our clients avoid paying for hundreds of hours of attorney time in litigation once a contract dispute arises."
      },
      {
        "title": "Business Consultation & Advice",
        "content": "Running a business is hard work. Our business attorneys help you lay the solid foundation so that it runs more smoothly – best practices for your contracts, business communications, employment relations, intellectual property and trade secret protective measures, insurance coverage, and litigation avoidance to name a few. Let our legal team help you so that you have the confidence to get business done the right way."
      },
      {
        "title": "Business Succession Planning",
        "content": "At some point, all business owners leave their businesses. In addition to enjoying peace of mind, business owners who have planned for their departures stand to profit much more than those owners who have not.\n\nGood succession planning involves legal, accounting, tax, and operational considerations. Our attorneys can identify the important legal considerations and provide you with advice and counsel to allow you to achieve both your business and personal objectives."
      },
      {
        "title": "Business Dispute Resolution",
        "content": "Inevitably, businesses need help resolving disputes that arise internally (among shareholders, members, or employment issues) or externally with vendors, landlords, customers, or competitors. Riley Bennett Egloff’s business litigators are experienced in helping to resolve disputes without litigation whenever possible, and pursuing or defending claims in litigation. Often, our attorneys work “behind the scenes” to make sure our clients are in the best position to prevail should litigation ensue – and you can rest assured that we’ll be honest with you if you need to employ other measures to avoid liability. Here, litigation attorneys are your allies who provide protection to your company’s interests well before you come near a courtroom, working hard to meet your goals as efficiently as expeditiously as possible."
      }
    ]
  },
  {
    "id": "business-litigation",
    "name": "Professionals in Business Litigation",
    ...
    "sections": [
      {
        ...
        "content": "Contract disputes form the basis for most business litigation. Ideally, every contract would be in writing and well-drafted. However, not all contracts are in writing, and even written contracts may inadvertently leave some issues unclear or unaddressed. Our business litigation attorneys excel in handling these and other complex factual and legal issues. Our attorneys have resolved hundreds of contract disputes through negotiation, alternative dispute resolution (ADR) including mediation and, if necessary, litigation. Whether your case involves a straightforward two-party dispute or more complicated issues involving several parties, multiple areas of the law, or a contract described in a dozen or more separate documents, our team of business litigation attorneys will work to resolve your matter with the careful consideration it deserves."
      },
      {
        "title": "Covenant Not to Compete",
        "content": "A covenant not to compete (also known as a non-competition covenant) can be an effective way to protect your business, whether you are protecting your existing business or buying a new one. Non-competition clauses are commonly included in employment contracts, sale agreements, and shareholder agreements. A well-drafted non-competition covenant may mean the difference between your business’ success or failure. However, courts often give non-competition covenants extra scrutiny, and there are circumstances where courts will not enforce them.\n\nOur experienced business litigation attorneys have an impressive track record representing companies, shareholders, and individual employees in disputes over non-competition agreements. We will help you draft and enforce your non-competition covenants to protect your business."
      },
      {
        "title": "Shareholder & Partnership Disputes",
        "content": "Like marriages, business partnerships and closely-held corporations begin with high hopes and much goodwill between the parties. Unfortunately, like some marriages, business partnerships occasionally end in acrimony and litigation.\n\nIn this complex area of law, you should seek counsel from attorneys experienced in shareholder and partnership disputes. Our business litigation attorneys regularly represent companies and their shareholders in these kinds of disputes. While our attorneys seek creative solutions to resolve these disputes without litigation when an amicable resolution is not possible they are ready to protect your interests through swift and decisive legal action."
      }
    ]
  },
  {
    "id": "commercial-litigation",
    "name": "Professionals in Commercial Litigation",
  ...
  },
  {
    ...
    "sections": [
      {
        "title": "Construction Litigation & Dispute Resolution",
  ...
  {
    "id": "health-care",
    "name": "Professionals in Health Care Law",
    "slug": "health-care",
    "description": "...",
    "icon": "Scale",
    "image": "https://rbelaw.com/wp-content/uploads/2024/08/Laura-Binford-Indianapolis-Med-Mal-Attorney-Partner-Riley-Bennett-Egloff-thumbnail-png.png",
    ...
    "sections": [
      {
        "title": "Health Care Regulation & Administration",
        "content": "Our health care attorneys provide counseling to our health care clients regarding a wide range of regulatory and administrative matters, including the following:"
      },
      {
        "title": "Medical Malpractice Defense",
        "content": "Our health care law attorneys have defended physicians, nurses, paramedics, dentists, hospitals, nursing homes, rehabilitation facilities, immediate care facilities, and other health care providers in medical malpractice actions for over thirty years. With this experience, our lawyers have developed the keen insight required to understand complex medical issues and the unique ability to break down and effectively present these issues to a medical review panel and when necessary to a judge and jury. Along with this insight, our Firm combines a work ethic and diligence that leaves no stone unturned in its defense of cases.\n\nIn addition to attorneys who have devoted their practices to the defense of medical professionals, we also have on staff experienced medical professionals who assist our attorneys in navigating the medical complexities of any particular case. We also have compiled an extensive expert witness database as an additional resource. Our medical malpractice defense team takes pride in providing excellent service to our health care clients, not only by explaining complex legal issues and answering questions thoroughly but also by keeping our clients informed of the status of their cases.\n\nWhile our Firm is always prepared to defend our health care clients, we realize that it is in our clients’ best interest to avoid a medical malpractice action when possible. Thus, our Firm also assists our health care clients in many different areas of their practice, including prevention of litigation through early resolution and risk management issues. Lawyers in the firm speak and provide presentations in these and other areas to our health care clients on a frequent basis."
      },
      {
        "title": "Medical Licensing Defense",
        "content": "Our health care law attorneys represents licensed medical professionals before the state boards and committees regulating practice. Riley Bennett Egloff attorneys have significant experience representing clients in licensure cases before the many state licensure boards; including the Indiana State Board of Nursing, Behavioral Health and Human Services Licensing Board, Indiana State Psychology Board, Indiana Respiratory Care Committee, Indiana Board of Pharmacy, Indiana Physical Therapy Committee, Indiana Occupational Therapy Committee, Indiana Board of Chiropractic Examiners, Indiana Optometry Board, Medical Licensing Board of Indiana, Indiana State Board of Health Facility Administrators, Indiana Speech-Language Pathology Audiology Board, and Indiana State Board of Dentistry."
      },
      {
        "title": "Riley Bennett Egloff assists professionals in all stages of licensing matters:",
        "content": "Our firm takes pride in preserving or reinstating our clients’ ability to practice their profession in Indiana without restriction. We work directly with our medical professional clients through every stage of the process as we strive to bring all cases to a beneficial and expeditious outcome."
      }
    ]
  },
  {
    ...
    "image": "https://rbelaw.com/wp-content/uploads/2024/08/Laura-Binford-Indianapolis-Med-Mal-Attorney-Partner-Riley-Bennett-Egloff-thumbnail-png.png",
    "keyServices": [
      "products liability environmental and toxic substance law officers’ and directors’ liability worker’s compensation claims; and general personal injury and property damage claims, including claims arising out of catastrophic construction site accidents",
      "products liability",
      "environmental and toxic substance law",
    ...
    "sections": [
      {
        ...
        "content": "Our attorneys provide legal services to insurance carriers including the defense of claims in the areas of:\n\nOur attorneys also defend professional negligence and malpractice claims asserted against accountants, attorneys, insurance agents, real estate brokers, physicians, dentists, hospitals and other service providers."
      },
      {
        "title": "Insurance Coverage",
        "content": "The expectations of policyholders do not always match the language of their insurance policies. When coverage disputes arise, insurance companies look to our attorneys for assistance in determining the extent of coverage described by an insurance policy under the specific facts presented. We work with both primary and excess insurance carriers to evaluate coverage, and to represent them in court actions where the court is asked to declare who is covered under a policy and/or the extent of the coverage provided.\n\nWe have assisted insurance companies in hundreds of insurance coverage disputes of all shapes and sizes, ranging from disputes about who is an insured under an automobile liability policy for a limited dollar claim, up to an environmental insurance coverage action involving hundreds of millions of dollars."
      },
      {
        "title": "Insurance Regulation",
        "content": "Our attorneys advise clients in virtually every segment of the insurance industry, providing guidance and advice to navigate compliance with Indiana insurance statues, regulations, rules, and bulletins. While first seeking resolution of disputes regarding regulatory compliance, we are also experienced in proactively representing clients in regulatory hearings and litigation in state and federal courts. Our clients include companies in the areas of property and casualty, life and health, managed care, reinsurance, insurance holding companies, risk retention groups, mutual companies, insurance agencies and brokerages, third party administrators, regulatory agencies, risk managers and trade groups.\n\nIn addition to regulatory compliance issues, our focus is always on identifying practical solutions to the challenges our insurance clients face in today’s complex marketplace regarding mergers and acquisitions, asset transfer transactions, intervention in various enforcement actions, reinsurance, and insolvency counseling."
      }
    ]
  },
  {
    "id": "intellectual-property-law-litigation",
    "name": "Professionals in Intellectual Property Law & Litigation",
    "slug": "intellectual-property-law-litigation",
    "description": "...",
    "icon": "Scale",
    "image": "https://rbelaw.com/wp-content/uploads/2024/08/Jaclyn-M-Flint-Attorney-Indiana-IP-Law-Construction-Sports-Entertainment-Commercial-Litigation-thumbnail.png",
    "keyServices": [],
    ...
    "sections": [
      {
        "title": "Registration of Copyrights & Trademarks",
        "content": "We assist software developers, media companies, musicians, artists, and others with the registration of their copyrighted works with the U.S. Copyright Office. We also register our clients’ product names, trade names, logos, and taglines with the U.S. Patent and Trademark Office as trademarks and service marks. Registration of copyrights, trademarks and service marks enable our clients to fully enforce their rights through litigation in the federal courts."
      },
      {
        "title": "Intellectual Property Licensing",
        "content": "We also protect our clients’ intellectual property rights by negotiating and documenting their licensing relationships, whether in the form of a true licensing agreement, or in conjunction with a product supply and distribution agreement, co-development agreement, software “click-wrap” agreement, or service agreements. Our goal is to ensure that our clients’ licensing relationships are certain, definite, and enforceable."
      },
      {
        "title": "Intellectual Property Litigation",
        "content": "We provide a wide range of litigation services to our clients in the area of intellectual property. Our litigators are experienced in the prosecution and defense of claims of patent infringement, copyright infringement, trademark infringement and dilution, trade dress infringement, and trade secret misappropriation. We also protect our clients’ Internet domain name registrations through ICANN arbitrations."
      }
    ]
  },
  {
    "id": "labor-employment-law",
    "name": "Professionals in Labor & Employment Law",
    "slug": "labor-employment-law",
    "description": "...",
    "icon": "Scale",
    "image": "https://rbelaw.com/wp-content/uploads/2020/04/WC-Button-250.jpg",
    "keyServices": [
    ...
    "sections": [
      {
        "title": "Labor Law",
        "content": "Our labor & employment attorneys assist employers in all industries with a full range of traditional labor law issues, such as:"
      },
      {
        "title": "Employment Law",
        "content": "Our labor & employment attorneys represent employers in a wide variety of employment law matters, including:"
      },
      {
        "title": "Non-Competition Agreements",
    ...
    "sections": [
      {
        ...
        "content": "We have handled all types of development and redevelopment, including residential and mixed use projects, office parks, distribution centers, health care facilities, shopping centers, and industrial facilities. Our services enable our clients to take a project from conception through the full approval process, up to and including the building permits. Our experience includes obtaining rezoning and master plan changes and zoning and land use approvals, including local and county application, land use counseling, and zoning litigation."
      },
      {
        "title": "Commercial Real Estate & Leasing",
        "content": "The experienced and knowledgeable real estate attorneys and staff are available to guide you through all aspects of acquisitions, approval, financing (including construction and permanent financing) and compliance with governmental regulations.\n\nIn particular, our attorneys have substantial experience negotiating commercial leases on behalf of tenants ranging in size from small, family-owned businesses to multi-national corporations. Commercial tenants often fail to negotiate their leases with their landlords, based on the mistaken belief that they have no choice but to sign the leases as presented by their landlords. While it is true that landlords have significant leverage in negotiations, there are important provisions in each commercial lease that can and should be negotiated, which can save tenants time, trouble, and money in the future."
      },
      {
        "title": "Residential Real Estate",
        "content": "Home ownership is the major financial transaction for most people. It is also a setting in which disputes occasionally arise, typically in construction. With experience representing builders and homeowners, our attorneys are ideally positioned to handle all kinds of disputes arising out of residential real estate and construction."
      }
    ]
  },
  {
    "id": "wills-trusts-estates",
    "name": "Professionals in Wills, Trusts & Estates",
    "slug": "wills-trusts-estates",
    "description": "...",
    "icon": "Scale",
    "image": "https://rbelaw.com/wp-content/uploads/2024/08/Ryan-Leitch-Indiana-Attorney-Trust-and-Estate-Law-Thumbnail-1.png",
    "keyServices": [],
    "overview": "",
    "sections": [
      {
        "title": "Business Succession Planning",
        "content": "As a business owner, you spent years creating and executing a successful business plan. It is equally important that you consider making necessary legal arrangements to protect the future of your business and your investments, through business succession planning.\n\nBusiness succession planning can protect and preserve your business or its value and involves making the legal, operational, and financial arrangements necessary to transfer your business to a partner or a family member, or to determine how your business should be sold, upon your retirement, incapacitation or death.\n\nFor business owners, business succession planning is a critical part of an overall estate plan. Our experienced attorneys can assist you in identifying your objectives and the available options for achieving them, in light of the applicable legal environment and tax considerations."
      },
      {
        "title": "Probate & Estate Administration",
        "content": "Our firm handles all aspects of probate and estate and trust administration. Probate is the legal process by which a person’s will is submitted to a Probate Court and administered. The provisions of the will determine how the decedent’s debts are paid and assets are distributed upon death.\n\nEstate and trust administration also includes assistance with non-probate transfers of the deceased’s assets, such as life insurance, annuities, and trust assets.\n\nOur lawyers assist personal representatives of estates and trustees of trusts in gathering, valuing, accounting for and distributing the decedent’s assets. We assist with the preparation of federal and state estate tax returns and other documents to release liens on a decedent’s real estate. As counsel for the personal representative or trustee, our responsibility is to ensure that all steps are properly taken in order to carry out the decedent’s intent, complete required administration activity, and transfer of assets to the appropriate family member or others in accordance with law."
      },
      {
        "title": "Estate Planning",
        "content": "It is neither difficult nor expensive to protect your assets and your family’s future with an estate plan. With the help of one of our experienced attorneys, you can have peace of mind that your loved ones will receive your property and understand your last wishes in a manner chosen by you.\n\nEstate planning usually starts with drafting a will or a trust, along with the use of a power of attorney. There are also other important documents you may want to include as well, called “advance directives,” which allow you to communicate your wishes for medical care and to give decision-making authority to a trusted friend or family member.\n\nOur attorneys are ready to help you consider all the issues involved in preparing these important documents. We will take the time to understand you, your family situation, and your goals in estate planning, to ensure your goals are achieved."
      }
    ]
  }
]
