/**
 * Attorney Carousel Search Component
 * Full search filter for homepage attorney carousel
 * Supports multiple selections like the /attorneys page
 */
...
export function AttorneyCarouselSearch({ onFilterChange }: AttorneyCarouselSearchProps) {
            ...
            <AnimatePresence>
              {practiceAreaDropdownOpen && (
                <motion.div
                  ...
                  onMouseEnter={handlePracticeAreaMouseEnter}
                  onMouseLeave={handlePracticeAreaMouseLeave}
                  className="absolute z-50 w-full mt-2 bg-white border-2 border-neutral-200 rounded-lg shadow-xl max-h-64 overflow-y-auto"
                >
            ...
            <AnimatePresence>
              {titleDropdownOpen && (
                <motion.div
                  ...
                  onMouseEnter={handleTitleMouseEnter}
                  onMouseLeave={handleTitleMouseLeave}
                  className="absolute z-50 w-full mt-2 bg-white border-2 border-neutral-200 rounded-lg shadow-xl"
                >
