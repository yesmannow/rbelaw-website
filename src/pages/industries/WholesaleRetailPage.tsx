...
import { ArrowRight, CheckCircle, Store, FileText, Users } from 'lucide-react'
import { SEOMeta } from '@/components/seo/SEOMeta'
import { ProfessionalCard } from '@/components/professionals/ProfessionalCard'
import { attorneys } from '@/lib/data/attorney-helpers'

export function WholesaleRetailPage() {
  const attorneyNames = [
    'Jeffrey S. Fecht',
    'Anthony R. Jost',
    'Ryan L. Leitch',
  ...
  const services = [
    'Advice and counsel on day-to-day employment matters',
    'Negotiating and drafting product sale and distribution agreements',
    'Mergers and acquisitions transactions',
    'Enforcement of non-competition covenants',
    'Intellectual property protection (licensing and litigation)',
    'Regional counsel for retail store lease negotiations',
  ]

  return (
    <>
      <SEOMeta
        title="Wholesale & Retail Sales | Riley Bennett Egloff LLP"
        description="Comprehensive legal services for companies in the wholesale and retail sales sector, including employment, distribution, M&A, IP, and leasing."
      />
      ...
      <div>
        ...
        <section className="relative bg-gradient-to-br from-primary-navy via-primary-navy to-primary-burgundy text-white pt-24 pb-20 lg:pt-32 lg:pb-24 overflow-hidden">
          <div className="absolute inset-0 z-0">
            <img src="/images/hero/hero 1.jpg" alt="Wholesale & Retail" className="w-full h-full object-cover opacity-20" />
          ...
          <div className="section-container relative z-10">
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }} className="max-w-4xl">
              ...
              <h1 className="text-5xl lg:text-6xl font-serif font-bold text-white mb-6">Wholesale & Retail Sales</h1>
              <p className="text-xl lg:text-2xl text-neutral-100 leading-relaxed">
                Representing companies across the wholesale and retail sectors with employment, distribution, M&A, IP, and real estate counsel.
              </p>
            </motion.div>
          </div>
        </section>
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-start">
              <motion.div initial={{ opacity: 0, x: -20 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }}>
                ...
                <div className="prose prose-lg text-neutral-700">
                  <p className="mb-4">
                    We represent a variety of companies in the wholesale and retail sales sector, including food manufacturers, pesticide distributors, janitorial suppliers, restaurants, and wireless providers.
                  </p>
                  <p className="mb-4">
                    In today’s ultra‑competitive environment, we assist clients with employment matters, distribution and M&A agreements, non‑competition enforcement, IP protection, and retail store leasing (including as regional counsel).
                  </p>
                </div>
              </motion.div>
        ...
        <section className="py-16 lg:py-20 bg-neutral-50">
          <div className="section-container">
            <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }} className="text-center mb-12">
              ...
              <p className="text-lg text-neutral-600 max-w-3xl mx-auto">Practical counsel for wholesale and retail operations</p>
            </motion.div>
        ...
        <section className="py-16 lg:py-20 bg-white">
          <div className="section-container">
            <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }} className="text-center mb-12">
              <h2 className="text-3xl lg:text-4xl font-serif font-bold text-primary-navy mb-4">Our Wholesale & Retail Team</h2>
              <p className="text-lg text-neutral-600 max-w-3xl mx-auto">Experienced counsel for wholesale and retail operations</p>
            </motion.div>
        ...
        <section className="py-16 bg-neutral-50">
          <div className="section-container">
            <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }} className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-lg text-neutral-700 mb-8 leading-relaxed">From employment and distribution to IP and leasing, we provide practical, business‑focused solutions.</p>
