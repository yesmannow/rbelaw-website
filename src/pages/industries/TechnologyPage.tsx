...
import { ArrowRight, CheckCircle, Cpu, FileText, Users } from 'lucide-react'
...
export function TechnologyPage() {
  ...
  const services = [
    'IP counseling for creation and transfer of rights',
    'Trademark, patent, copyright, and trade secret matters',
    'Registration of rights (national and international)',
    'Infringement litigation and enforcement',
    'Licensing agreements: drafting, negotiation, and disputes',
  ]

  const clientTypes = [
    'Technology rights owners',
    'Software and platform developers',
    'Startups and growth-stage companies',
    'Enterprises commercializing IP portfolios',
  ]

  return (
    <>
      <SEOMeta
        title="Technology | Riley Bennett Egloff LLP"
        description="Substantial experience representing owners of technology rights across IP counseling, registration, licensing, and litigation."
      />
      ...
      <div>
        ...
        <section className="relative bg-gradient-to-br from-primary-navy via-primary-navy to-primary-burgundy text-white pt-24 pb-20 lg:pt-32 lg:pb-24 overflow-hidden">
          <div className="absolute inset-0 z-0">
            <img src="/images/hero/hero 1.jpg" alt="Technology" className="w-full h-full object-cover opacity-20" />
          ...
          <div className="section-container relative z-10">
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }} className="max-w-4xl">
              ...
              <h1 className="text-5xl lg:text-6xl font-serif font-bold text-white mb-6">Technology</h1>
              <p className="text-xl lg:text-2xl text-neutral-100 leading-relaxed">
                Counseling technology rights owners on creation, transfer, registration, licensing, and enforcement of intellectual property rights.
              </p>
            </motion.div>
          </div>
        </section>
          ...
          <div className="section-container">
            <div className="grid lg:grid-cols-2 gap-12 items-start">
              <motion.div initial={{ opacity: 0, x: -20 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }}>
                <h2 className="text-3xl lg:text-4xl font-serif font-bold text-primary-navy mb-6">IP Counseling and Litigation</h2>
                <div className="prose prose-lg text-neutral-700">
                  <p className="mb-4">
                    Our Firm has substantial experience representing owners of technology rights. We counsel clients with respect to legal issues that arise in the creation and transfer of IP rights, including trademarks, patents, copyrights, and trade secrets.
                  </p>
                  <p className="mb-4">
                    We provide a range of services for counseling IP owners and registering those rights on a national and international basis, and we represent clients in infringement litigation and licensing disputes.
                  </p>
                </div>
              </motion.div>
        ...
        <section className="py-16 lg:py-20 bg-neutral-50">
          <div className="section-container">
            <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }} className="text-center mb-12">
              ...
              <p className="text-lg text-neutral-600 max-w-3xl mx-auto">Comprehensive IP and technology transactions counsel</p>
            </motion.div>
        ...
        <section className="py-16 lg:py-20 bg-white">
          <div className="section-container">
            <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }} className="text-center mb-12">
              <h2 className="text-3xl lg:text-4xl font-serif font-bold text-primary-navy mb-4">Our Technology Team</h2>
              <p className="text-lg text-neutral-600 max-w-3xl mx-auto">Experienced counsel across IP and technology transactions</p>
            </motion.div>
        ...
        <section className="py-16 bg-neutral-50">
          <div className="section-container">
            <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }} className="max-w-4xl mx-auto text-center">
              <h2 className="text-3xl lg:text-4xl font-serif font-bold text-primary-navy mb-6">Partner with Experienced Technology Counsel</h2>
              <p className="text-lg text-neutral-700 mb-8 leading-relaxed">From registration to licensing and litigation, we protect and maximize your IP assets.</p>
