...
import { ArrowRight, CheckCircle, Utensils, FileText, Users } from 'lucide-react'
...
export function RestaurantPage() {
  ...
  const clientTypes = [
    ...
    'Distributors',
    'Retailers in the food service industry',
  ]
  ...
  const services = [
    ...
    'Contractual disputes and general business litigation',
  ...
  return (
    <>
      <SEOMeta
        title="Restaurant & Hospitality | Riley Bennett Egloff LLP"
        description="Comprehensive legal services for restaurants, manufacturers, processors, distributors, and retailers in the food service industry."
      />
      ...
      <div>
        ...
        <section className="relative bg-gradient-to-br from-primary-navy via-primary-navy to-primary-burgundy text-white pt-24 pb-20 lg:pt-32 lg:pb-24 overflow-hidden">
          <div className="absolute inset-0 z-0">
            <img src="/images/hero/hero 1.jpg" alt="Restaurant & Hospitality" className="w-full h-full object-cover opacity-20" />
          ...
          <div className="section-container relative z-10">
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }} className="max-w-4xl">
              ...
              <h1 className="text-5xl lg:text-6xl font-serif font-bold text-white mb-6">Restaurant & Hospitality</h1>
              <p className="text-xl lg:text-2xl text-neutral-100 leading-relaxed">
                Experienced legal team offering a broad array of services to help companies thrive in today's competitive environment.
              </p>
            </motion.div>
          </div>
        </section>
          ...
          <div className="section-container">
            <div className="grid lg:grid-cols-2 gap-12 items-start">
              <motion.div initial={{ opacity: 0, x: -20 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }}>
                <h2 className="text-3xl lg:text-4xl font-serif font-bold text-primary-navy mb-6">Focused on Growth and Protection</h2>
                <div className="prose prose-lg text-neutral-700">
                  <p className="mb-4">
                    To address the challenges and opportunities available to companies in today’s competitive environment, our Firm offers an experienced legal team providing a broad array of services, including organizational structuring, mergers and acquisitions, general contracts, intellectual‑property protection, and day‑to‑day operational counsel.
                  </p>
                  <p className="mb-4">
                    In litigation, we represent members of the food service industry in contractual disputes, labor and employment litigation, and general business litigation.
                  </p>
                </div>
              </motion.div>
        ...
        <section className="py-16 lg:py-20 bg-neutral-50">
          <div className="section-container">
            <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }} className="text-center mb-12">
              ...
              <p className="text-lg text-neutral-600 max-w-3xl mx-auto">Strategic and operational counsel for the food service industry</p>
            </motion.div>
        ...
        <section className="py-16 lg:py-20 bg-white">
          <div className="section-container">
            <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }} className="text-center mb-12">
              <h2 className="text-3xl lg:text-4xl font-serif font-bold text-primary-navy mb-4">Our Restaurant & Hospitality Team</h2>
              <p className="text-lg text-neutral-600 max-w-3xl mx-auto">Experienced counsel for food service companies</p>
            </motion.div>
        ...
        <section className="py-16 bg-neutral-50">
          <div className="section-container">
            <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }} className="max-w-4xl mx-auto text-center">
              <h2 className="text-3xl lg:text-4xl font-serif font-bold text-primary-navy mb-6">Partner with Experienced Counsel</h2>
              <p className="text-lg text-neutral-700 mb-8 leading-relaxed">From formation and IP to litigation, we help food service companies manage risk and grow.</p>
