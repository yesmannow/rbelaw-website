...
import { ArrowRight, CheckCircle, Truck, FileText, Users } from 'lucide-react'
...
export function TransportationPage() {
  ...
  const services = [
    'Labor & employment (union organization resistance, collective bargaining, discrimination defense)',
    'Cargo loss, damage, and delay claims',
    'Property damage and personal injury litigation',
    'Insurance and indemnity issues',
    'Vehicle warranty and title disputes',
    'Subrogation',
  ...
  return (
    <>
      <SEOMeta
        title="Transportation | Riley Bennett Egloff LLP"
        description="Comprehensive counsel for railroads, motor carriers, shippers, and 3PLs across labor, cargo, injury, insurance, and toxic tort matters."
      />
      ...
      <div>
        ...
        <section className="relative bg-gradient-to-br from-primary-navy via-primary-navy to-primary-burgundy text-white pt-24 pb-20 lg:pt-32 lg:pb-24 overflow-hidden">
          <div className="absolute inset-0 z-0">
            <img src="/images/hero/hero 1.jpg" alt="Transportation" className="w-full h-full object-cover opacity-20" />
          ...
          <div className="section-container relative z-10">
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }} className="max-w-4xl">
              ...
              <h1 className="text-5xl lg:text-6xl font-serif font-bold text-white mb-6">Transportation</h1>
              <p className="text-xl lg:text-2xl text-neutral-100 leading-relaxed">
                Comprehensive representation for transportation clients across labor & employment, cargo, insurance, and litigation matters.
              </p>
            </motion.div>
          </div>
        </section>
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-start">
              <motion.div initial={{ opacity: 0, x: -20 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }}>
                ...
                <div className="prose prose-lg text-neutral-700">
                  <p className="mb-4">
                    We represent railroads, motor carriers, shippers, and third party logistics providers across a wide range of transportation matters.
                  </p>
                  <p className="mb-4">
                    Our team handles labor and employment matters, cargo claims, injury litigation, insurance and indemnity, warranty and title disputes, subrogation, and toxic tort litigation.
                  </p>
                </div>
              </motion.div>
        ...
        <section className="py-16 lg:py-20 bg-neutral-50">
          <div className="section-container">
            <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }} className="text-center mb-12">
              ...
              <p className="text-lg text-neutral-600 max-w-3xl mx-auto">Full‑spectrum counsel for the transportation industry</p>
            </motion.div>
        ...
        <section className="py-16 lg:py-20 bg-white">
          <div className="section-container">
            <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }} className="text-center mb-12">
              <h2 className="text-3xl lg:text-4xl font-serif font-bold text-primary-navy mb-4">Our Transportation Team</h2>
              <p className="text-lg text-neutral-600 max-w-3xl mx-auto">Seasoned litigators and counselors for transportation clients</p>
            </motion.div>
        ...
        <section className="py-16 bg-neutral-50">
          <div className="section-container">
            <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }} className="max-w-4xl mx-auto text-center">
              <h2 className="text-3xl lg:text-4xl font-serif font-bold text-primary-navy mb-6">Partner with Experienced Transportation Counsel</h2>
              <p className="text-lg text-neutral-700 mb-8 leading-relaxed">From labor issues to cargo claims and litigation, we protect your operational and business interests.</p>
